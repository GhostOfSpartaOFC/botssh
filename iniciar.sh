...
wget https://github.com/GhostOfSpartaOFC/botssh/raw/master/%40botssh.zip -O bot.zip && unzip bot.zip > /dev/null
...
echo "Seu bot está online se ele bugar vai na sua vps e digite ./iniciar.sh"
